...
| **TRUST.md** | Rewrite | Index of internal/ops docs (INCIDENT_PROCESS, OBSERVABILITY, ALERTS, OPERATIONS, SLOs). Replaced with short user-facing trust page: security summary, data retention, status page; no incident/ops links. |
