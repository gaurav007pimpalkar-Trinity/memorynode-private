-- 035_bump_usage_if_within_cap_hotfix.sql
-- Hotfix: re-create bump_usage_if_within_cap with fully-qualified references to
-- prevent "column reference workspace_id is ambiguous" in mixed DB histories.
